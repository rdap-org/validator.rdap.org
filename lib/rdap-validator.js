...
rdapValidator.testURL = function(url, type, serverType) {
    ...
    rdapValidator.addResult(null, "Testing URL '" + url + "'");
    rdapValidator.addResult(null, "Response type '" + type + "'");
    rdapValidator.addResult(null, "Server type " + serverType + "'");
...
rdapValidator.validateDomain = function(domain, url, serverType) {
    ...
    rdapValidator.addResult(null, "validating domain response for " + name + "...");
...
rdapValidator.validateIP = function(url, record, serverType) {
    rdapValidator.addResult(null, "validating IP networks is a work-in-progress...");
};

rdapValidator.validateASN = function(url, record, serverType) {
    rdapValidator.addResult(null, "validating AS numbers is a work-in-progress...");
};

rdapValidator.validateHelp = function(url, record, serverType) {
    rdapValidator.addResult(null, "validating Help responses is a work-in-progress...");
};

rdapValidator.validateDomainSearch = function(url, record, serverType) {
    rdapValidator.addResult(null, "validating domain searches is a work-in-progress...");
};

rdapValidator.validateNameserverSearch = function(url, record, serverType) {
    rdapValidator.addResult(null, "validating nameserver searches is a work-in-progress...");
};

rdapValidator.validateEntitySearch = function(url, record, serverType) {
    rdapValidator.addResult(null, "validating entity searches is a work-in-progress...");
};

rdapValidator.validateError = function(url, record, serverType) {
    rdapValidator.addResult(null, "validating errors is a work-in-progress...");
};
