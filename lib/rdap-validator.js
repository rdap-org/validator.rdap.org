 ...
 * @param {object} topmost whether this object appears as the topmost object or is embedded
 */
rdapValidator.validateDomain = function(domain, url, serverType, topmost) {
    ...
    if (domain.hasOwnProperty("unicodeName")) {
        ...
        rdapValidator.pushPath(".popPath");
    }
...
rdapValidator.validateGTLDRegistrarDomainResponse = function(domain) {
    rdapValidator.addMessage("validation of domain responses from gTLD registrars is a work in progress...");
};
...
rdapValidator.validateCommonGTLDDomainResponse = function(domain) {
    rdapValidator.addMessage("gTLD domain validation is a work-in-progress.");
};
 ...
 */
rdapValidator.validateRIRASN = function(autnum, url) {
    rdapValidator.addMessage("validating RIR responses is a work-in-progress...");
};
...
/**
 * validate an entity response for a gTLD registrar.
 */
rdapValidator.validateGTLDRegistrarEntityResponse = function(entity) {
    rdapValidator.addMessage("TODO");
};

/**
 * validate an nameserver response for a gTLD registrar.
 */
...
/**
 * validate an entity response for a thick gTLD registry.
 */
...
/**
 * validate a nameserver response for a thick gTLD registry.
 */
...
/**
 * validate an entity response for a thin gTLD registry.
 */
...
/**
 * validate a nameserver response for a thin gTLD registry.
 */
