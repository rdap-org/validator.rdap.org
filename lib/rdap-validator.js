...
rdapValidator.testResponse = function(xhr, url, type, serverType) {
    ...
    switch (type) {
        ...
        case "nameserver":
            ...
            switch (serverType) {
                case "gtld-registry":   rdapValidator.validateGTLDNameserver(record, name); break;
                case "rir":             rdapValidator.validateRIRNameserver(record, name); break;
            }
        ...
        case "entity":
            ...
            switch (serverType) {
                case "gtld-registry":   rdapValidator.validateGTLDEntity(record, handle); break;
                case "rir":             rdapValidator.validateRIREntity(record, handle); break;
            }
        ...
        case "error":
            ...
            switch (serverType) {
                case "gtld-registry":   rdapValidator.validateGTLDError(record); break;
                case "gtld-registrar":  rdapValidator.validateGTLDError(record); break;
                case "rir":             rdapValidator.validateRIRError(record); break;
            }
            break;
...
rdapValidator.validateNoticeOrRemark = function (noticeOrRemark) {
    ...
    rdapValidator.popPath(".description");
...
rdapValidator.validateCommonGTLDResponseProperties = function(response) {
    ...
    self.addResult(
        self.lastTestedResponseHeaders.toLowerCase().indexOf("access-control-allow-origin: *") >= 0,
...
rdapValidator.validateCommonGTLDDomainProperties = function(domain, name) {
    ...
    rdapValidator.validateGTLDNameProperties(domain, name);
 ...
 * nameserver objects.
*/
rdapValidator.validateGTLDNameProperties = function(object, name) {
...
rdapValidator.validateGTLDNameserver = function(nameserver, name) {
    self.validateCommonGTLDResponseProperties(nameserver);

    if (rdapValidator.isObject(nameserver)) {
        rdapValidator.validateGTLDNameProperties(nameserver, name);
...
self.validateGTLDError = function(error) {
    rdapValidator.addMessage("TODO - validate gTLD error response");
};

self.validateRIRError = function(error) {
    rdapValidator.addMessage("TODO - validate RIR error response");
};
