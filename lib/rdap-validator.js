...
self.validateResponse = function(json) {
    ...
    self.validateObjectClassName(json);
 ...
 */
self.validateObjectClassName = function(record) {
    if (self.objectTypes.indexOf(self.lastTestedResponseType) >= 0) {
        ...
        if (
            ...
            self.add(
                self.lastTestedResponseType == record.objectClassName,
                `The value of the 'objectClassName' property ('${record.objectClassName}') MUST be '${self.lastTestedResponseType}'.`,
                self.objectClassNameReferences[self.lastTestedResponseType],
            );
        }
