...
rdapValidator.testResponse = function(xhr, url, type, serverType) {
    ...
    switch (type) {
        case "domain":
            ...
            switch (serverType) {
                case "thin-gtld-registry":  rdapValidator.validateThickGTLDDomain(record); break;
                case "thick-gtld-registry": rdapValidator.validateThinGTLDDomain(record); break;
                case "gtld-registrar":      rdapValidator.validateGTLDRegistrarDomain(record); break;
                case "rir":                 rdapValidator.validateRIRDomain(record); break;
            }
 ...
 */
rdapValidator.validateThinGTLDDomain = function(domain) {
    ...
    rdapValidator.validateCommonGTLDDomain(domain);
};
 ...
 */
rdapValidator.validateThickGTLDDomain = function(domain) {
 ...
 */
rdapValidator.validateGTLDRegistrarDomain = function(domain) {
 ...
 */
rdapValidator.validateCommonGTLDDomain = function(domain) {
 ...
 */
rdapValidator.validateRIRDomain = function(domain) {
